...
Санкт-Петербург, Ленинградское шоссе, 81Б, д. Юкки
      ...
      <section className="dark-alt">
        ...
        По желанию можно добавить изящный красный акцент — помада, украшение, сумка, туфли, галстук, платок. 
      ...
      <section className="dark-alt">
        ...
        <ul className="details-list reveal-item" data-reveal-index="10">
          ...
          <p>В место цветов нам будет особенно приятно получить бутылочку вашего любимого напитка. Добавьте к ней маленькое пожелание — на какой особенный момент нам стоит её открыть. Мы с радостью будем вспоминать вас в эти счастливые мгновения</p>
          </li>
          <li>
            <span className="details-num">    
                  <img
